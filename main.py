...
async def universal_text_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Sab text messages yahan aate hain. Admin action ho ya normal button."""
    user = update.effective_user
    text = update.message.text.strip()

    # ─── First check: Admin action mode ───
...
def main():
    ...
    # Universal text handler — admin actions AND buttons AND fallback
